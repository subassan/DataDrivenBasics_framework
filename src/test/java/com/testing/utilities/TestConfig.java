...
public class TestConfig{
	...
	public static String from = "subassan@gmail.com.com";
	public static String password = "Blockchain001";
	public static String[] to ={"skb8304@gmail.com","sumit1801308@gmail.com"};
